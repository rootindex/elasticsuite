...
class Merchandising extends \Magento\Catalog\Block\Adminhtml\Form
{
     ...
     * @param \Magento\CatalogRule\Model\RuleFactory    $ruleFactory   Catalog product rule factory.
    ...
    private function addVirtualCategorySettings(\Magento\Framework\Data\Form $form)
    {
        ...
        $virtualRuleRenderer = $this->getLayout()->createBlock('Magento\CatalogWidget\Block\Product\Widget\Conditions');
