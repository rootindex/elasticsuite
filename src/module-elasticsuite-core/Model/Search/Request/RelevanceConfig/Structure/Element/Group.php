...
use Magento\Config\Model\Config\Structure\Element\Iterator\Field as CoreField;
...
class Group extends \Magento\Config\Model\Config\Structure\Element\Group
{
     ...
     * @param CoreField             $childrenIterator  The children iterator
